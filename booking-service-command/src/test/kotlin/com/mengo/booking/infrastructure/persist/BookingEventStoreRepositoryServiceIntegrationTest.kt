...
class BookingEventStoreRepositoryServiceIntegrationTest : AbstractIntegrationTest() {
    @Autowired
    private lateinit var jpaRepository: BookingEventStoreJpaRepository

    @Autowired
    private lateinit var mapper: BookingEventEntityMapper

    @Autowired
    private lateinit var repository: BookingEventStoreRepositoryService
