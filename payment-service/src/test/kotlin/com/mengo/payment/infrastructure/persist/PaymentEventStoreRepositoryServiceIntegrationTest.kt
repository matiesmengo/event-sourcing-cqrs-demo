...
class PaymentEventStoreRepositoryServiceIntegrationTest
    @Autowired
    constructor(
        private val jpaRepository: PaymentEventStoreJpaRepository,
        private val mapper: PaymentEventEntityMapper,
        private val repository: PaymentEventStoreRepositoryService,
