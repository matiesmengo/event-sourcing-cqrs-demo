...
class BookingE2ETest : AbstractServicesE2ETest() {
    ...
    fun `booking to payment flow E2E`() {
        ...
        await().atMost(Duration.ofSeconds(30)).untilAsserted {
            ...
            assertTrue(
                bookingTypes.contains("BookingPaymentCompletedEvent"), // TODO: after create image ->  BookingPaymentConfirmedEvent
            ...
            assertTrue(
                paymentTypes.contains("PaymentCreatedEvent"), // TODO: after create image ->  PaymentInitiatedEvent
